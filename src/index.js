...
export default class VideoTrimmer {
  ...
  async trimVideo() {
    ...
    modalFooter.innerHTML = `<button id="addlessons" class="modal-button">Add to Course</button>`;
  ...
  handleUpdateName(index) {
    const editName = window.document.getElementsByClassName("edit-trimmedvideoname")[index];
