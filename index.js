class VideoTrimmer {
    ...
    initializeFilePond() {
        ...
        `,
          ...
          `;
                const videoElement =
                    window.document.querySelector('.view-video');
